...
# -Each avenger is represented by another dictionary, 
# and has a name (Tony Stark and Bruce Banner respectively) and another dictionary containing their attacks.
...
HulkSmashMovePower = avengers["Hulk"]["attacks"]["smash"]
print(HulkSmashMovePower)